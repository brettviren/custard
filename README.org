...
#+setupfile: http://brettviren.github.io/export/setup/theme-darksun-qqq.setup
...
- [[file:pigenc_stream.hpp][~pigenc_stream.hpp~]] :: adds to ~pigenc.hpp~ the streaming of C++
